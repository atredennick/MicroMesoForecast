...
*Andrew T. Tredennick[^corrauth], Department of Wildland Resources and the Ecology Center, Utah State University, Logan, UT*
...
Figures
-------
```{r fig.cap="Work flow of the data aggregation, model fitting, and population simulating.", fig.width=5, fig.height=8}
library(png)
library(grid)
