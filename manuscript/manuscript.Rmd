...
Forecasts from IPMs with climate covariates had significantly lower error than equivalent QBM forecasts for *P. smithii* ($t_{(216)}$ = -3.49, *P* < 0.001) and *Poa secunda* ($t_{(196)}$ = -1.83, *P* = 0.034) (Fig. S2, Supporting Information).
Results from all pairwise statistical tests are shown in Table S21 of the Supporting Information.
