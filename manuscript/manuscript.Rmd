...
Basing population models on population- rather than individual-level data in a climate change context is hampered by the fact that it is individuals that respond to climate, not populations [@Clark2012]. This fact puts us in uneasy proximity to an "ecological fallacy" where one deduces inference on the individual from statistical inference on the group [@PIANTADOSI1988].   
