...
Since the IPM is spatially-implicit, we cannot calculate neighborhood crowding for specific genets ($w_{ij}$). Instead, we use an approximation ($\bar{\bold{w_{j}}}$) that captures the essential features of neighborhood interactions [@Adler2010]. We also use a 'no-overlap' rule for conspecific genets to approximate the overdispersion of large genets in space [@Adler2010; @Adler2012; @Chu2015].
