...
Do we need detailed demographic data to forecast the impacts of climate change on populations?
========================================================================================
...
Figures
-------
```{r figure_1,dependson="plot-options", fig.cap="Work flow of the data aggregation, model fitting, and population simulating.", fig.height=6}
library(png)
library(grid)
