...
We found some evidence that the QBM missed important climate effects for three species (*B. gracilis*, *H. comata*, and *Poa secunda*), where important climate effects were identified in the individual vital rate models but not in the percent cover model (Fig. 3).
...
We did find that IPM forecast accuracy was significantly higher than the QBM for one species, *P. smithii* (Fig. 2, `climate' bars).
But, the fact that *P. smithii* IPM outperformed the QBM with climate covariates included is a moot point because including the climate covariates in the IPM did not increase forecast accuracy over an IPM without climate covariates (Fig. 2).
