...
The posterior distributions of climate effects included in our models broadly overlapped zero (Fig. 3), but including climate covariates did increase the accuracy of forecasts for all species except *P. smithii* (Fig. 2).
