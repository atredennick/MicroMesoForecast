...
\begin{figure}[!ht]
  ...
  \caption{The forecast horizons for both models when used to forecast the final observation (cover in year 1945) starting from all possible prior years. For example, simulations initialized with cover in 1932 have 13 years before the forecast.}
\end{figure}
...
\begin{figure}[!ht]
  \centering
      \includegraphics{./components/climate_effect_corplots.png}
