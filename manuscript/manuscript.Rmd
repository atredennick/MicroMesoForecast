...
##  QBM results
# Read in data
qbm_onestep <- readRDS("../analysis/quadBM/simulations/validation_results/qbm_one-step_forecasts_combined.rds")
# Average predictions over quad-year reps
...
# ipm_diffs <- readRDS("../montana/ipm/simulations/results/ipm_climatesims_logdiffs.RDS")
# ipm_diffs$model <- rep("IPM", nrow(ipm_diffs))
# ipm_diffs$type <- rep("paramunc", nrow(ipm_diffs))
# ipm_diffs2 <- readRDS("../montana/ipm/simulations/results/ipm_climatesims_logdiffs_mean.RDS")
# ipm_diffs2$model <- rep("IPM", nrow(ipm_diffs))
# ipm_diffs2$type <- rep("parammean", nrow(ipm_diffs))
# ipm_diffs$med_cover <- ipm_diffs2$med_cover
# ipm_diffs <- rbind(ipm_diffs, ipm_diffs2)

# ggplot(ipm_diffs)+
#   geom_hline(aes(yintercept=0), linetype=2)+
#   geom_errorbar(aes(x=species, ymin=lo_cover, ymax=up_cover, group=variable),
