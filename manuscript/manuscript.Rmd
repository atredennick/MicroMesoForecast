...
Figures
-------
```{r figure_1, dependson="plot-options", fig.cap="Time series of average percent cover of our four focal species: *Bouteloua gracilis* (BOGR), *Hesperostipa comata* (HECO), *Pascopyrum smithii* (PASM), and *Poa secunda* (POSE).", fig.height=4}
...
ggplot(avgobs, aes(x=(1900+year), y=mean_cover*100, shape=Species, linetype=Species))+
  geom_line()+
