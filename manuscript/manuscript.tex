...
climate change on
populations?}\label{do-we-need-detailed-demographic-data-to-forecast-the-impacts-of-climate-change-on-populations}
...
Such models do not require individual level demographic data. Indeed,
Queenborough et al. (2011) provide empirical evidence that
density-structured models adequately described population dynamics. The
...
species (Fig. 2a-d). In a perfect world, the QBM would have made
...
(Fig. 2e-h) that we cannot say that the two model's forecasts were
...
individual level data but not in the aggregate level data. However, the
species with recruitment and survival rates most sensitive to climate
factors (\emph{P. secunda}; Fig. 3d) was also the only species for which
the IPM and QBM made consistent forecasts (Fig. 2d).

Individual growth was the most sensitive vital rate to climate factors
for all species (Fig. 3). Individual plant growth, if survival of large
plants is high, likely plays the biggest role in year-to-year percent
cover at the plot level. Therefore, we would naively expect forecasts
from the two models to be consistent. Since this was not the case, and
other vital rates were relatively insensitive to
