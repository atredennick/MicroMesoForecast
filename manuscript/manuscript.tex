...
Percent cover data collected by typical sampling protocals (e.g., Daubenmire frames) will include error that may affect population forecasts due to misspecifing the initial conditions and/or biasing model parameters}
...
(Petchey et al. 2015).
\textcolor{blue}{For example, IPMs are typically capable of estimating equilibrium abundances}
