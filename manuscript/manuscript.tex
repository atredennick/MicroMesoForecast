...
species: \emph{B. gracilis} and \emph{Poa secunda}
...
\textcolor{blue}{And, thanks to Andy Kleinhesselink for discovering an error in our computer code before this paper was published.}
