...
measure precision calculated the distance between the upper and lower
90th quantiles of the 100 predictions as a measure of forecast precision
and averaged this value over quadrat-years for each species.
...
precipitation and temperature increased by 1\%. We ran this simulations
...
for two species (\emph{H. comata} and \emph{P. smithii}; Table 1). In no
case did the QBM significantly outperform the IPM (Table 1). The IPM was
consistently more precise than the QBM, with lower distances between the
90\% quantiles across all species (Table 1). In general the IPM
outperformed the QBM because it had (i) lower MAE for two species, (ii)
statistically similar MAE for the other two species, and (iii)
