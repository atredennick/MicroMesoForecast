...
quadrats. For most of the remaining discussion of statistical modeling
we refer to proportion data, which is simply percent data divided by
100.
...
parameters from a beta regression in quadrat-based population model the
simulated population tended toward 100\% cover for all species. We
...
Scale reduction factors for all parameters were less than 1.01,
...
the three MCMC chains for all parameters to be used as randomly drawn
values during population simulation.
...
each time step, we first randomly selected climate covariates from one
of the 14 observed years and also randomly drew one set of random year
effects for each vital rate regression. Climate years and random year
effects were drawn independently because they were uncorrelated. Then,
we drew the full parameter set (specific random year effects, climate
effects, fixed effects) from a randomly selected MCMC iteration. We
selected random year effects and the climate year independently.
...
\begin{tabular}{lllrrrr}
  \hline
Model & Species & Year Structure & Mean & SD & Min & Max \\ 
  \hline
IPM & BOGR & Full & -0.24 & 5.78 & -46.52 & 43.05 \\ 
  IPM & BOGR & Climate & -0.28 & 11.40 & -230.10 & 47.81 \\ 
  IPM & HECO & Full & -0.29 & 0.95 & -10.99 & 4.33 \\ 
  IPM & HECO & Climate & 0.14 & 1.05 & -8.65 & 6.67 \\ 
  IPM & PASM & Full & -0.04 & 0.30 & -4.29 & 1.04 \\ 
  IPM & PASM & Climate & 0.05 & 0.20 & -2.04 & 0.99 \\ 
  IPM & POSE & Full & -0.58 & 1.65 & -30.73 & 7.34 \\ 
  IPM & POSE & Climate & 0.23 & 1.51 & -6.08 & 14.32 \\ 
  QBM & BOGR & Full & -2.06 & 12.45 & -81.48 & 52.88 \\ 
  QBM & BOGR & Climate & -1.86 & 13.61 & -94.71 & 54.33 \\ 
  QBM & HECO & Full & -0.25 & 2.28 & -68.53 & 7.84 \\ 
  QBM & HECO & Climate & -0.47 & 3.49 & -94.57 & 7.91 \\ 
  QBM & PASM & Full & -0.04 & 0.50 & -15.13 & 1.56 \\ 
  QBM & PASM & Climate & -0.05 & 0.53 & -9.69 & 1.67 \\ 
  QBM & POSE & Full & -0.05 & 2.07 & -58.34 & 13.97 \\ 
  QBM & POSE & Climate & -0.01 & 2.47 & -73.14 & 15.18 \\ 
   \hline
\end{tabular}
\caption{Table of residual summary statistics.} 
\end{table}
...
\caption{One step forecasts from IPM version.}
\end{figure}
