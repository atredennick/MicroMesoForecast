...
& \qquad & \beta_{d,1} \sim \text{Normal}(0, 100^2) \\
& \qquad & \beta_{d,2} \sim \text{Normal}(0, 100^2) \\
& \qquad & \tilde{\beta_0} \sim \text{Normal}(0, 100^2) \\
& \qquad & \tilde{\beta_s} \sim \text{Normal}(0, 100^2) \\
...
& \qquad & \boldsymbol{\beta_{Q}} \sim \text{Normal}(0, \sigma_Q^2 \textbf{I}) \\
& \qquad & \boldsymbol{\beta}_c \sim \text{Normal}(0, \sigma_c^2 \textbf{I}) \\
& \qquad & \beta_{d,1} \sim \text{Normal}(0, 10^2) \\
& \qquad & \beta_{d,2} \sim \text{Normal}(0, 10^2) \\
& \qquad & \tilde{\beta_0} \sim \text{Normal}(0, 100^2) \\
& \qquad & \tilde{\beta_s} \sim \text{Normal}(0, 100^2) \\
& \qquad & \sigma_Q \sim \text{Cauchy}(0, 2) \\
& \qquad & \sigma_{\beta_0} \sim \text{Cauchy}(0, 2) \\
& \qquad & \sigma_{\beta_s} \sim \text{Cauchy}(0, 2) \\
& \qquad & a \sim \text{Normal}(0, 100^2) \\
& \qquad & b \sim \text{Normal}(0, 100^2)
\end{align}
...
& \qquad & \tilde{\beta_0} \sim \text{Normal}(0, 1000^2) \\
& \qquad & \sigma_Q \sim \text{Cauchy}(0, 5) \\
& \qquad & \sigma_{\beta_0} \sim \text{Cauchy}(0, 5) \\
...
& \qquad & \boldsymbol{\beta}_c \sim \text{Normal}(0, \sigma_c^2 \textbf{I}) \\
& \qquad & \tilde{\beta_0} \sim \text{Normal}(0, 1000^2) \\
& \qquad & \tilde{\beta_s} \sim \text{Normal}(0, 1000^2) \\
& \qquad & \sigma_Q \sim \text{Cauchy}(0, 5) \\
& \qquad & \sigma_{\beta_0} \sim \text{Cauchy}(0, 5) \\
& \qquad & \sigma_{\beta_s} \sim \text{Cauchy}(0, 5) \\
