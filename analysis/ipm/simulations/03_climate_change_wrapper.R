...
for(ispp in 1:length(spp_list)){
  ...
  write.table(output,outfile,row.names=F,sep=",")
  cat("\n") # makes a space before next line printing
  cat(paste("DONE WITH", spp_list[ispp], "FOR INCREASE PRECIPITATION SIMULATION"))
  cat("\n") # makes a space before next line printing
}
...
for(ispp in 1:length(spp_list)){
  ...
  write.table(output,outfile,row.names=F,sep=",")
  cat("\n") # makes a space before next line printing
  cat(paste("DONE WITH", spp_list[ispp], "FOR INCREASE TEMPERATURE SIMULATION"))
  cat("\n") # makes a space before next line printing
}
...
####
####  SIMULATION 4: INCREASE IN PRECIPITATION AND TEMPERATURE
####
...
for(ispp in 1:length(spp_list)){
  ...
  write.table(output,outfile,row.names=F,sep=",")
  cat("\n") # makes a space before next line printing
  cat(paste("DONE WITH", spp_list[ispp], "FOR INCREASE PRECIPITATION & TEMPERATURE SIMULATION"))
  cat("\n") # makes a space before next line printing
}
