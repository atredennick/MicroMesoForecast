...
for(ss in 1:n_spp){
  doSpp <- spp_list[ss]
  outfile1<-paste("./results/cc_rectest/",doSpp,"_ipm_cover_obsClimate.csv",sep="")
  outfile2<-paste("./results/cc_rectest/",doSpp,"_ipm_density_obsClimate.csv",sep="")
  outfile3<-paste("./results/cc_rectest/",doSpp,"_ipm_stableSize_obsClimate.csv",sep="")
  climtag <- "obs"
...
for(ss in 1:n_spp){
  doSpp <- spp_list[ss]
  outfile1<-paste("./results/cc_rectest/",doSpp,"_ipm_cover_pptChange.csv",sep="")
  outfile2<-paste("./results/cc_rectest/",doSpp,"_ipm_density_pptChange.csv",sep="")
  outfile3<-paste("./results/cc_rectest/",doSpp,"_ipm_stableSize_pptChange.csv",sep="")
  climtag <- "ppt"
  source("ipm_climate_simulations.R", echo = FALSE)
...
for(ss in 1:n_spp){
  doSpp <- spp_list[ss]
  outfile1<-paste("./results/cc_rectest/",doSpp,"_ipm_cover_tempChange.csv",sep="")
  outfile2<-paste("./results/cc_rectest/",doSpp,"_ipm_density_tempChange.csv",sep="")
  outfile3<-paste("./results/cc_rectest/",doSpp,"_ipm_stableSize_tempChange.csv",sep="")
  climtag <- "temp"
  source("ipm_climate_simulations.R", echo = FALSE)
...
for(ss in 1:n_spp){
  doSpp <- spp_list[ss]
  outfile1<-paste("./results/cc_rectest/",doSpp,"_ipm_cover_temppptChange.csv",sep="")
  outfile2<-paste("./results/cc_rectest/",doSpp,"_ipm_density_temppptChange.csv",sep="")
  outfile3<-paste("./results/cc_rectest/",doSpp,"_ipm_stableSize_temppptChange.csv",sep="")
  climtag <- "zppttemp"
  source("ipm_climate_simulations.R", echo = FALSE)
