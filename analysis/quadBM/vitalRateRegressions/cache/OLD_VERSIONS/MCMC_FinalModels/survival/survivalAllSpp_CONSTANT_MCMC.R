...
for(spp in 1:length(sppList)){
  ...
  mod <- jags.model("survivalAllSpp_CONSTANT_JAGS.R", data=dataJ, n.chains=3, n.adapt=adapt)
  ...
  write.csv(outDeviance, file=paste(doSpp, "_survivalDevianceCONSTANT.csv", sep=""))
}
